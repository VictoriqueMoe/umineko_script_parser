...
func (p *Parser) parseDialogue(cmdTok ast.Token) *ast.DialogueLine {
	var elements []dialogue.DialogueElement
...
func (p *Parser) parseFormatTagContent(tok ast.Token) dialogue.DialogueElement {
	...
	var nested []dialogue.DialogueElement
	if content != "" {
...
func (p *Parser) parseNestedContent(content string) []dialogue.DialogueElement {
	var elements []dialogue.DialogueElement
...
func (p *Parser) parseInlineCommandContent(tok ast.Token) dialogue.DialogueElement {
