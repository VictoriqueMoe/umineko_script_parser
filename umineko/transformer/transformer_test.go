...
func TestCollectFromScript_IgnoresNonPresetLines(t *testing.T) {
	...
	expected := len(DefaultDynamicColours()) + 1
...
func TestHtml_Italic(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "i",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "emphasis"}},
		},
	}
...
func TestHtml_ItalicLongForm(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "italic",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "text"}},
		},
	}
...
func TestHtml_Colour(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "c",
			Param:   "FF0000",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "red"}},
		},
	}
		...
		t.Run(name, func(t *testing.T) {
			...
			elements := []dialogue.DialogueElement{
				&ast.FormatTag{
					Name:    name,
					Param:   "00FF00",
					Content: []dialogue.DialogueElement{&ast.PlainText{Text: "green"}},
				},
			}
...
func TestHtml_Ruby(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "ruby",
			Param:   "Beatrice",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "Golden Witch"}},
		},
	}
...
func TestHtml_RubyShortForm(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "h",
			Param:   "reading",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "kanji"}},
		},
	}
...
func TestHtml_PresetRedTruth(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "p",
			Param:   "1",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "I speak the red truth!"}},
		},
	}
...
func TestHtml_PresetBlueTruth(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "preset",
			Param:   "2",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "Counter!"}},
		},
	}
...
func TestHtml_PresetGoldTruth(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "p",
			Param:   "41",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "gold text"}},
		},
	}
...
func TestHtml_PresetPurpleTruth(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "p",
			Param:   "42",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "purple text"}},
		},
	}
...
func TestHtml_PresetUnknown_FallsThrough(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "p",
			Param:   "99",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "unstyled"}},
		},
	}
...
func TestHtml_YTag_Stripped(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		...
		&ast.FormatTag{
			Name:    "y",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "hidden"}},
		},
...
func TestHtml_NTag_WithContent(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "n",
			Param:   "1",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "conditional text"}},
		},
	}
...
func TestHtml_UnknownTag_PassesContent(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:    "nobr",
			Content: []dialogue.DialogueElement{&ast.PlainText{Text: "no break"}},
		},
	}
...
func TestHtml_NestedTags(t *testing.T) {
	...
	elements := []dialogue.DialogueElement{
		&ast.FormatTag{
			Name:  "p",
			Param: "1",
			Content: []dialogue.DialogueElement{
				&ast.PlainText{Text: "Red with "},
				&ast.FormatTag{
					Name:    "i",
					Content: []dialogue.DialogueElement{&ast.PlainText{Text: "italic"}},
				},
			},
		},
	}
	...
	for _, tag := range tags {
		t.Run(tag, func(t *testing.T) {
			elements := []dialogue.DialogueElement{
				&ast.FormatTag{
					Name:    tag,
					Content: []dialogue.DialogueElement{&ast.PlainText{Text: "content"}},
				},
			}
			got := tr.Transform(elements)
			if got != "content" {
...
func (m *mockTransformer) Transform(elements []dialogue.DialogueElement) string {
	return "mock"
}
